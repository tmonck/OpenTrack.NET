...
namespace OpenTrack.Requests
{
    ...
    public class ClosedRepairOrderLookup : IRequest<OpenTrack.Responses.ClosedRepairOrderLookupResponse>
    {
        public ClosedRepairOrderLookup(String EnterpriseCode, String DealerCode)
