...
namespace OpenTrack
{
    ...
    public class OpenTrackAPI : IOpenTrackAPI
    {
        ...
        private const string SERVICE_PRICING_LOOKUP_ACTION = "opentrack.dealertrack.com/ServicePricingLookupResponse";
        ...
        public ServicePricingLookupResult ServicePricingLookup(ServicePricingLookupRequest request)
        {
            var url = string.Format("{0}/{1}", this.BaseUrl, "WebService.asmx");
            var envelope = new Envelope<ServicePricingLookupRequestBody>
            {
                Header = new Header(),
                Body = new ServicePricingLookupRequestBody
                {
                    ServicePricingLookupRequest = request
                }
            };
            ...
            return response.Body.ServicePricingLookupResult;
        }
